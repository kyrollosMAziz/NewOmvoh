...
public class MeetingRoomManager : MonoBehaviour
{
    ...
    [Header("SFX")] [SerializeField] AudioSource _meetingBgSFX;
    ...
    [Header("Halfway Presentation")] [SerializeField]
    AudioClip _halfwayPresentationMale;

    [SerializeField] AudioClip _halfwayPresentationFemale;

    [Header("Oh No")] [SerializeField] AudioClip _ohNoMale;
    [SerializeField] AudioClip _ohNoFemale;

    [Header("This Can't Happen")] [SerializeField]
    AudioClip _thisCantHappenMale;

    [SerializeField] AudioClip _thisCantHappenFemale;

    [Header("How Do I Leave")] [SerializeField]
    AudioClip _howDoILeaveMale;

    [SerializeField] AudioClip _howDoILeaveFemale;

    [Header("This Is Unpro")] [SerializeField]
    AudioClip _thisIsUnprofessionelMale;
